...
namespace Nez
{
    ...
    public class TrailRibbon : RenderableComponent, IUpdatable
    {
        ...
        public float ribbonsToDraw = 1;

        public Vector2 fixPosition = Vector2.Zero;
        ...
        void initializeVertices()
        {
            ...
            // head of ribbon
            _vertices[0].Position = new Vector3(entityPosition, 0f) + radiusVec;
            _vertices[0].Color = Color.Red;
            _vertices[1].Position = new Vector3(entityPosition, 0f) + radiusVec;
            _vertices[1].Color = Color.Yellow;
            _vertices[2].Position = new Vector3(entityPosition, 0f) + radiusVec;
        ...
        void IUpdatable.update()
        {
            ...
            var entityPosition = fixPosition == Vector2.Zero ? entity.transform.position : fixPosition;
            var velocity = entityPosition - _segments.First.Value.position;
        ...
        public override void render(Graphics graphics, Camera camera)
        {
            ...
            var num = (int)((_ribbonLength * 2 + 1) * ribbonsToDraw);
            if (num > 0)
                Core.graphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleStrip, _vertices, 0, num);
        }
