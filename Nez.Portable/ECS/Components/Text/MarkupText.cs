...
namespace Nez
{
    ...
    public class MarkupText : RenderableComponent
    {
        ...
        private float _resultTextWidth;
        public float resultTextWidth => _resultTextWidth;
        ...
        public MarkupText setAlpha(float alpha)
        {
            _alpha = alpha;
            return this;
        }
        ...
        public void compile()
        {
                ...
                else if (reader.NodeType == XmlNodeType.Text)
                {
                    ...
                    while (words.Length > wordIndex)
                    {
                        ...
                        if ((isLastWord || !currentWordFits) && textRun.Length > 0)
                        {
                            ...
                            lineBuffer.Add(new CompiledTextElement(textRun.ToString(), position, currentFormatting, this));
                            textRun.Clear();
            ...
            _resultTextWidth = lineWidths.Max();
    ...
    struct CompiledTextElement : ICompiledElement
    {
        ...
        readonly MarkupText _markupText;
        readonly FormatInstruction _formatInstruction;
        readonly string _text;


        public CompiledTextElement(string text, Vector2 position, FormatInstruction formatInstruction, MarkupText markupText)
        {
        ...
        public void render(Graphics graphics, Vector2 offset)
        {
            ...
            graphics.batcher.drawString(_formatInstruction.font, _text, offset + position, _markupText.color * _markupText.alpha, 0, origin, _formatInstruction.scale, SpriteEffects.None, 0);
        }
